...
TORFILE=/groups/reich/melissa/mutation_rate_project/analysis_round1/autosomal_estimates/constraint2/replication_timing/Koren_etal_TableS2_hg19.bed

BASEDIR=/groups/reich/melissa/mutation_rate_project/analysis_round1/constraint